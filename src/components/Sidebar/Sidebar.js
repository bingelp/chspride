...
class Sidebar extends React.Component {
  SidebarButton(props) {
    return props.to.startsWith("/") ? (
      <Link
        className={"btn btn-raised btn-block btn-" + props.background}
        to={props.to}
      >
    ...
    return (
      ...
      >
        <div className="sb-slidebar-container">
          <header className="ms-slidebar-header" onClick={this.imageClick} />
          {this.props.bottom.map(b => (
            <this.SidebarButton
              key={b.key}
              to={b.to}
              icon={b.icon}
