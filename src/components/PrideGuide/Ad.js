      ...
      <div className="col-md-6">
        <div>
          ...
          <ul>
            ...
            <li>Distribution to Charleston, Mount Pleasant, James
            Island, Johns Island, Edisto, Beaufort, Columbia,
              Myrtle Beach, Greenville, Spartanburg, Savannah, Asheville, and Charlotte</li>
          </ul>
        </div>
        <div>
          <h3>Added Value</h3>
        ...
        <div>
          ...
          <ul>
            <li>Purchase your ad by <strong>April 30 2018</strong>, and get into the
LGBTA Preferred Directory in the Guide</li></ul>
        </div>
      </div>
      <div className="col-md-6">
        <div>
        ...
        <div>
          <h4>For questions about ad specs or to have Charleston Pride
design an ad on your behalf, please contact 
    ...
    return (
      ...
      <div className="col-12 text-center">
        ...
        <div>
          ...
          <p>For, <strong>$1,500</strong>, make a major statement for your
business or organization with an exclusive
center fold ad in the middle of the Charleston
Pride Guide</p>
            <ul>
          ...
          <div>
            ...
            <p>For <strong>$1,000</strong>, your ad can be placed on one of the
prominent inside covers, printed on glossy paper.
There are only two of these coveted spaces so
order early to guarantee your spot.</p>
            <ul>
              <li>5.75" W x 8.75" H (includes bleed)</li>
              <li>Keep text 0.5" away from the edges</li>
            </ul>
        ...
        <div className="col-md-6">
            <div>
              <h2>Full Page</h2>
              <p>For <strong>$750</strong>, you will get a full page ad in the
Charleston Pride Festival Guide. <strong>Great</strong> Visibility!</p>
              <ul>
                <li>5.75" W x 8.75" H (includes bleed)</li>
                <li>Keep text 0.5" away from the edges</li>
              </ul>
          ...
          <div>
            <h2>Half Page</h2>
            <p>For <strong>$500</strong>, receive a half-page as in the Charleston
Pride Festival Guide. While half-page ads may
share a page with others ads or text, they still
give your business or organization enough space
to make a colorful statement.</p>
            <ul>
          ...
          <div>
            <h2>Quarter Page</h2>
            <p>For <strong>$350</strong>, feature your business in a simple yet
elegant way with a quarterpage ad. This ad size
features enough space to highlight your business
at a very affordable rate <strong>or</strong> purchase two
separate ads for double coverage.</p>
            <ul>
  ...
  Form(){
    return (
      <div className="text-center">
        ...
        <p>For questions about ad specs or to have Charleston Pride
design an ad on your behalf, please contact
