      ...
      <div>
        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <BoardMember id="2" exec="true" firstName="Devon" lastName="Turner" elected="May 2014" email="devon.turner" title="Vice Chair / Chief Operating Officer" photoSrc={devon} pronouns="He/Him/His" >
              <p>Originally from Pennsylvania, Devon has lived in Charleston for 10 years and has been involved in the nonprofit sector ever since high school. He is passionate about board service and advancing the visibility and acceptance of the LGBTQ community.</p>
              <p>When he’s not volunteering on the Pride board, you can find him at Omatic Software where he works with nonprofits to better manage their data, at the beach soaking up the sun and enjoying a good book, or in class getting a Master’s in Public Administration at the College of Charleston. His greatest achievement will be learning how to successfully pull off a death drop without breaking any bones.</p>
            </BoardMember>
            ...
            <BoardMember id="4" exec="true" firstName="Regina" lastName="Duggins" elected="July 2017" email="regina.duggins" title="Secretary of the Board" photoSrc={regina} pronouns="She/Her/Hers" >
            ...
            <BoardMember id="5" firstName="Adam" lastName="Weaver" elected="November 2016" email="adam.weaver" title="Director of Volunteers" photoSrc={adam} pronouns="He/Him/His" >
              <p>Adam is a graduate of Boston University, as well as Francis Marion University, where he received his master’s degree in instructional accommodation. Originally from the little town of Bethlehem (the one in Pennsylvania), Adam moved to Charleston in 2013 as a corps member in Teach for America. He taught special education at West Ashley High for three years before transitioning into his role as the Specialized Medical Case Manager at Lowcountry AIDS Services. As a Director At-Large, Adam hopes to develop more Pride events and experiences for LGBTQ+ youth.</p>
              <p>Outside of work, Adam can be found with his dog Ralph in tow as they continue to explore all that Charleston has to offer. Both enjoy long walks on the beach, antiquing, photography, woodworking, fighting for social justice, and a good gluten-free treat.</p>
            </BoardMember>
            <BoardMember id="6" firstName="Mollie" lastName="Soto" elected="November 2017" email="mollie.sott" title="Director of Events" photoSrc={mollie} pronouns="She/Her/Hers" >
              ...
              <p>As Director of Events, Mollie hopes to develop more diverse Pride events and volunteer opportunities in the community. Outside of work, you may find Mollie on the tennis courts, the beach or hanging out with her dog Marley.</p></BoardMember>
            <BoardMember id="7" firstName="Adam" lastName="Cabe" elected="November 2017" email="adam.cabe" title="Festival Director" photoSrc={adam2} pronouns="He/Him/His" >
              <p>Bio coming soon.</p>
            </BoardMember>
            <BoardMember id="8" firstName="Clark" lastName="Haywood" elected="November 2017" email="clark.haywood" title="Director of Communications" photoSrc={clark} pronouns="He/Him/His" >
            ...
            <BoardMember id="9" firstName="Pete" lastName="Bingel" elected="November 2017" email="peter.bingel" title="Director of Technology" photoSrc={pete} pronouns="He/Him/His" >
            ...
            <BoardMember id="12" firstName="Vanity" lastName="Deterville" elected="January 2018" email="vanity.deterville" title="Director of Outreach" photoSrc={vanity} pronouns="She/Her/Hers" >
            ...
            <BoardMember id="13" firstName="Joseph" lastName="Kaiser" elected="November 2016" email="jospeh.kaiser" title="Director of At-Large" photoSrc={joseph} pronouns="He/Him/His" >
              <p>Joseph is from Mount Pleasant, SC but currently resides in downtown Charleston, SC. He graduated from Clemson University in 2008 and the Charleston School of Law in 2011. After law school, Joseph worked as a prosecutor for a local municipality.</p>
              <p>In August 2016, Joseph opened his own law firm in Charleston, SC focusing primarily on criminal defense and personal injury. When he’s not at work, Joseph can be found either in Clemson cheering for the Tigers or traveling around the country especially in the Pacific Northwest.</p>
              <p>Joseph serves as a member at large on the Board of Directors and looks forward to helping other Board members accomplish their goals.</p>
            </BoardMember>
          </div>
          <h2 className="text-center">Vacancies</h2>
          <div className="row">
            <VacantBoardMember id="10" title="Director of Sponsorships" />
            <VacantBoardMember id="11" title="Director At-Large" />
