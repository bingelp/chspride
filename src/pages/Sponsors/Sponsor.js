...
export default class Sponsor extends React.Component {
    ...
    <div className="ms-thumbnail-container">
        <figure className={"ms-thumbnail ms-thumbnail-bottom ms-thumbnail-"+ helper(this.props.meta.level)}>
            <img src={"https://d2f908d3j7stzr.cloudfront.net/chspride/sponsors/"+this.props.meta.image} alt={this.props.meta.name} className="img-fluid"></img>
            <figcaption className="ms-thumbnail-caption text-center">
                <div className="ms-thumbnail-caption-content">
                    ...
                    <a href={this.props.meta.web+"?utm_source=charleston_pride&utm_medium=website&utm_campaign=sponsors"} target="_blank" rel="noopener noreferrer" className={"btn-circle btn-circle-raised btn-circle-" +helper(this.props.meta.level)}>
