          ...
          <div className="col-md-4 d-none d-lg-block pricing-col col-push-1">
            <div className="pricing-table pricing-table-description">
              ...
              <ul className="pricing-table-content">
                ...
                <li>
                  <i className="fa fa-facebook"></i> Custom Media Posts </li>
                <li>
                  <i className="fa fa-male"></i> Recognition on Pride T-shirt </li>
                <li>
                <i className="fa fa-ticket"></i> Complimentary Tickets to the Prism Party </li>
                <li>
                <i className="fa fa-thumbs-up"></i> Complimentary Booth at Festival </li>
                <li>
                <i className="fa fa-newspaper-o"></i> Complimentary Ad Space in Pride Guide </li>
                <li>
                  <i className="fa fa-star"></i> Access to VIP Tent at Pride Festival</li>
                <li>
