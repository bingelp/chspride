      ...
      <div className="row justify-content-center">
        <div className="col-10">
          <h4>
            ...
            organization that celebrates the LGBTQ community throughout the year
            and holds an annual Parade and Festival in downtown Charleston.
            Throughout the main week of Pride events, participants can attend
            various events all focused on educating the community and promoting
            equality.
          </h4>
          ...
          <div className="container">
            <div className="text-center">
              ...
              <p className="lead lead-sm color-white text-center center-block mt-2 mw-800 fw-300 animated fadeInUp animation-delay-6">
                ...
                people. Additionally, a sponsorship will promote your
