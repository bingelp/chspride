          ...
          <div className="row">
            <div className="col-12 col-md-6">
              ...
              <p className="wow fadeInUp animation-delay-3">
                Thousands will line the streets of historic downtown Charleston
                to come out to celebrate diversity and to support equal rights
                for all citizens.
              </p>
              ...
              <ol className="service-list list-unstyled">
                <li>
                  ...
                  <strong>Ann Street</strong> and{" "}
                  <strong>Meeting Street</strong>.
                </li>
                <li>
                  Immediately, the parade proceeds to{" "}
                  <strong>King Street</strong> and heads south on King,
                  traveling past <strong>Marion Square</strong>, the heart of
                  downtown Charleston.
                </li>
                <li>
                  Once the parade hits <strong>Broad Street</strong>, the
                  procession takes a right and continues until reaching{" "}
