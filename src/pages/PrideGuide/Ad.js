        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-6">
              ...
              <div>
                <h4>
                  For questions about ad specs or to have Charleston Pride
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              <div>
                ...
                <p>
                  ...
                  the middle of the Charleston Pride Guide
                </p>
                <ul>
              ...
              <div>
                ...
                <p>
                  ...
                  only one back cover, so buy your ad soon!
                </p>
                <ul>
            ...
            <div className="col-md-6">
              <div>
                <h2>Full Page</h2>
                <p>
                  For <strong>$750</strong>, you will get a full page ad in the
                  Charleston Pride Festival Guide. <strong>Great</strong>{" "}
                  Visibility!
                </p>
                <ul>
                  <li>5.75" W x 8.75" H (includes bleed)</li>
              ...
              <div>
                ...
                <p>
                  ...
                  Charleston Pride Festival Guide. While half-page ads may share
                  a page with others ads or text, they still give your business
                  or organization enough space to make a colorful statement.
                </p>
                <ul>
