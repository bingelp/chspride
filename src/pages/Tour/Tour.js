          ...
          <div className="container">
            <div className="text-center">
              ...
              <h3 className="lead color-white text-center center-block mt-2 mw-800 fw-300 animated fadeInUp animation-delay-7">
                Sunday, September 8, 2019 @ 3:00 PM - 5:00 PM | 18 Anson St
              </h3>
            </div>
          </div>
        </div>
          ...
          <div className="card">
            <div className="card-body">
              <p>
                ...
                first transsexuals in the US, the gay artists that helped create
                Charleston’s Art Renaissance, the significance of The Battery in
                LGBT society, The Spoleto Festival, and the historic Charleston
                landmark where Gertrude Stein and Alice Taklas spent Valentine’s
                Day. Join Charleston Pride and{" "}
                <ExternalLink
