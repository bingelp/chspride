                        ...
                        <div className="card-body">
                            <div className="row">
                                <div className="col">
                                    ...
                                    <p>All you need is a ticket and we will provide the rest! Boarding will begin at 7:30pm at the Aquarium Wharf (360 Concord St, Charleston, SC). The boat will depart at 8:00 pm and will return at 11:00 pm. Space is limited so make sure you get your tickets early. All proceeds benefit Charleston Pride and help to make Pride possible!</p>
                                </div>
                            </div>
                            <div className="row">
                                <div className="col">
                                    <em>This event is 21 and up. You must have your ID ready to present at the dock. We will have your name at the dock along with the number of tickets you purchased. Please arrive at the dock with your group. Everyone in your group must have IDs. All sales are final. This event is free for Friends of Pride</em>
                                </div>
                            </div>
                        </div>
                    </div>
