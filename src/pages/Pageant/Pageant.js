            ...
            <div className="ms-hero-page-override ms-hero-img-pageant ms-hero-bg-royal">
                <div className="container">
                    <div className="text-center">
                        ...
                        <h2 className="lead lead-lg color-white text-center center-block mt-2 mw-800 fw-300 animated fadeInUp animation-delay-7">
                            Tickets: $10 @ Door (Cash &amp; Card)</h2>
                        <CountdownClock eventTime="2018-08-25T21:00:00" color="warning" />

                        {props.showRegistration && <a href="#register" className="btn btn-raised btn-royal">Register</a>}
                        {props.showRegistration && <a className="btn btn-raised color-royal btn-white" download="Pageant_App_18.pdf" href={PageantApp}>Sign up to Compete</a>}
                    </div>
                </div>
            </div>)
    }
            ...
            <div className="container mt-6">
                <div className="row">
                    <div className="col-12 col-lg-6">
                        ...
                        {props.showRegistration && <p>Potential registrants can fill out the registration form below, and the official application is available for download below. Contestants must be registered by August 20th.</p>}
                        {props.showRegistration && <a className="btn btn-info pull-right btn-raised" download="Pageant_App_18.pdf" href={PageantApp}><i className="fa fa-download"></i> Sign up to Compete</a>}
                    </div>
                    <div className="col-12 col-lg-6">
