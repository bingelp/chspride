            ...
            <div className="row justify-content-center">
              <div className="col-lg-8">
                ...
                <p className="lead lead-lg text-center mt-4 col">
                  ...
                  The standard fee for vendors is <strong>$150</strong>. If
                  electricity is needed, <strong>$25.00</strong> will be added
                  to the registration. Nonprofit organizations are entitled to a{" "}
                  <strong>50% discount</strong>. Proof of nonprofit status must
                  be file with Charleston Pride Festival prior to{" "}
                  {nonProfitDate}.
                </p>
                <p className="lead lead-lg text-center col">
                  ...
                  does not supply tents, tables or chairs. Vendor packets will
                  be sent to the email address on file by {packetsSent}.
                </p>
                <p className="lead lead-lg text-center col">
                  Please note that vendors are required to meet certain
                  obligations, including, but not limited to, providing proof of
                  liability insurance and the appropriate licenses for Food and
                  Beverage vending. Vendors must submit these documents to our
                  vendor coordinator at
                  <a
